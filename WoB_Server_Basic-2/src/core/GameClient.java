...
import networking.request.RequestAddMoney;
...
public class GameClient implements Runnable {
            ...
            try {
                ...
                if (requestLength > 0) {
                    ...
                    if (request != null) {
                        ...
                        //System.out.println("Request_code in client " + this.toString());
                        ...
                        //extract response from responses queue and send back to client
                        try {
                            ...
                            for (GameResponse response : request.getResponses()) {
                                ...
                                send(response);
                                //System.out.println("sent response, line 103, GameClient" + response.toString());
                            }
                    ...
                    if ((System.currentTimeMillis() - lastActivity) / 10000 >= Constants.TIMEOUT_SECONDS) {
                        isDone = true;
                    }
                }
            } catch (Exception ex) {
    ...
    public boolean addResponseForUpdate(GameResponse response) {
        //System.out.println("before: " + updates.size()+ " player_id " + this.getUserID());
        updates.add(response);
        //System.out.println("after: " + updates.size()+ " player_id " + this.getUserID());
        return true;
    }
    ...
    public Queue<GameResponse> getUpdates() {
        ...
        //System.out.println("client.player_id: " + this.getUserID()+" Updates Size: "+updates.size());
        synchronized (this) {
